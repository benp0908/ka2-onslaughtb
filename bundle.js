                        ...
                        if (!b.hideGui) {
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    if (b.showDebug) {
                                        W[6].draw("KA2's Arras",
                                            h + 200, m - 84 - 2, 15, l.blue, "right");
                                    ...
                                    } else W[6].draw("KA2's Arras", h + 200, m - 42 - 2, 15, l.blue, "right");
                                    W[2].draw("Client Speed: " + J.rendertime + " FPS", h + 200, m - 28, 10, 10 < J.rendertime ? l.green : l.orange, "right");
                                    W[1].draw("Server Speed: " + (100 * A.fps).toFixed(2) + "%", h + 200, m - 14, 10, 1 === A.fps ? l.green : l.orange, "right");
